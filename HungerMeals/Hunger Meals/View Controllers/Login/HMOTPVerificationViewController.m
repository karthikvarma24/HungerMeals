  ...
  //  [self performSelectorOnMainThread:@selector(showActivityIndicatorWithTitle:) withObject:kIndicatorTitle waitUntilDone:NO];
    ...
    [service otpGenaration:dict usingBlock:^(NSString *resultMessage) {
        ...
        if (result==nil) {
            ...
            [self showAlertWithTitle:@"alert !!" andMessage:@"Unable to send OTP to your mobile number"];

        }
        
        else{
            
            //[self showAlertWithTitle:@"alert !!" andMessage:@"Successfully sent OTP to your mobile number"];
