    ...
    [service getLocationsDataUsingBlock:^(id result, NSHTTPURLResponse *response, NSError *err)  {
        ...
        [self.settingsTableView reloadData];
            ...
            if (response.statusCode==0) {
                ...
                [BTAlertController showAlertWithMessage:@"Your internet appears to be offline" andTitle:nil andOkButtonTitle:nil andCancelTitle:@"Ok" andtarget:self andAlertCancelBlock:^{
                ...
                [BTAlertController showAlertWithMessage:@"Unable to get locations" andTitle:nil
                                       andOkButtonTitle:nil andCancelTitle:@"Ok" andtarget:self andAlertCancelBlock:^{
