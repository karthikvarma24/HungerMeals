...
- (void)viewDidLoad {
    ...
    userData = [NSKeyedUnarchiver unarchiveObjectWithData:archiverData];
...
-(void)initPayment {
    ...
    NSString *email = [NSString stringWithFormat:@"%@",userData.email];
    NSString *phone =  userData.phone_no;
    NSString *firstname = userData.name;
...
- (void)delayedDidFinish:(NSString *)getStringFromUrl {
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        [mutDictTransactionDetails setObject:userData.name forKey:@"Payee_Name"];
        [mutDictTransactionDetails setObject:Product_Info forKey:@"Product_Info"];
        [mutDictTransactionDetails setObject:paymentString forKey:@"Paid_Amount"];
